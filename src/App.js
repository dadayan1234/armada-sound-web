      ...
      <div className="relative h-screen overflow-hidden">
        ...
        <div className="relative z-10 flex items-center justify-center h-full px-4">
          <div className="text-center text-white max-w-4xl animate-fade-in">
            <img src="/img/logo.PNG" alt="Armada Sound Logo" className="w-37 h-37 mx-auto rounded-full shadow-2xl object-cover mb-8 transform hover:scale-105 transition-transform duration-300" />
